...
export const FilterLabel = Roll.querySelector(".Filter").querySelector("span");
...
export function FormatTime(EpochTime = 0, Pattern = "") {
    ...
    if (Pattern.replace(Pattern.split(" ").find(Now => Now.startsWith("&now")), "").trim() === "hh and mm ago" && HoursAgo >= 24 * 7) return `${DaysAgo % 7} week${DaysAgo % 7 > 1 ? "s" : ""} ago`;
